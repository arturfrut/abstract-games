...
blocks:
    ...
    features:
      ...
      - color: bg-[#fc0] text-black
        ...
        content: >
          ...
          Experience a straightforward website with powerful features. It seamlessly handles various content types and even accommodates custom integrations.
      - icon: /src/icons/blocks-group-solid.svg
        content: >
          ### Page Block Builder
  ...
  - type: text_image
    ...
    content: >
      ...
      Discover the seamless integration of powerful features, empowering you to efficiently oversee your website directly within a Static CMS. Whether your offerings include blogs, portfolios, or menus, Nebulix boasts a wealth of exceptional features, making it an ideal choice for the majority of small websites. 
